            ...
            <FadeUp delay={0.2}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                <Link href="/draw">
                  <Button
                    size="lg"
                    className="  gap-2 py-8 px-12 bg-purple-700 hover:bg-purple-800 hover:shadow-lg rounded-full hover:scale-105 transition-all duration-150"
                  >
                    <Image
                      src="/landing-page/start-drawing.svg"
                      alt="Start Drawing"
                      width={200}
                      height={200}
                    />
            ...
            <div className="grid md:grid-cols-3 px-8 gap-16 items-center lg:gap-48 max-w-7xl mx-auto">
              <FadeUp delay={0.2}>
                <div className="text-center space-y-4">
                  <Image
                    src="/landing-page/just-draw-illustration.svg"
                    alt="Just Draw"
                    width={550}
                    height={126}
                    className="mx-auto "
              ...
              <FadeUp delay={0.3}>
                <div className="text-center space-y-4">
                  <Image
                    src="/landing-page/janky-lines-illustration.svg"
                    alt="Janky Lines"
                    width={550}
                    height={126}
                    className="mx-auto"
              ...
              <FadeUp delay={0.5}>
                <div className="text-center space-y-4">
                  <Image
                    src="/landing-page/easy-export-illustration.svg"
                    alt="Easy Export"
                    width={550}
                    height={126}
                    className="mx-auto"
